...
const email = require("../assets/icons/icon_main.png") as string
const phone = require("../assets/icons/icon_whatsapp.png") as string
const instagram_contact = require("../assets/icons/icon_instagram.png") as string
